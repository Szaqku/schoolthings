...
public:
    ...
    Zawodnik(string line, string delimiter);
    void printZawodnik();
    void printResults();
    void setKlub(Klub*);
    Klub* getKlub();
    ...
    bool operator==(Zawodnik& a){
        return (this->pesel == a.pesel);
    }
...
Zawodnik::Zawodnik(string line, string delimiter){
    string zbr[7];
    int i = 0;
    size_t pos = 0;
    ...
    this->imie  = zbr[0];
    this->nazwisko = zbr[1];
    this->miejsce1 = stoi(zbr[2]);
    this->miejsce2 = stoi(zbr[3]);
    this->miejsce3 = stoi(zbr[4]);
    this->pesel = zbr[5];
    this->dataUrodzenia = zbr[6];
}
...
int main(int argc, char** argv) {
    ...
    Zawodnik* zawodnik = new Zawodnik("Jan;Nowak;1;2;3;3578939579;21.02.1777",";");
    Zawodnik* b = new Zawodnik();

    cout<<*zawodnik<<endl;
    cout<<(zawodnik == b)<<endl;
